 ...
 */ (function() {
    ...
    if (document.readyState === 'loading') document.addEventListener('DOMContentLoaded', initProductTabs);
    else initProductTabs();
})();

//# sourceMappingURL=landing-page.bd2113f6.js.map
